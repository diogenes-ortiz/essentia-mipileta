...
5. **"Essentia desde adentro"** — *(ago 2026: se movió ACÁ, justo después de "Conocé cada
   ...
   - **Desagüe** (ago 2026): foto `desague-essentia.jpg` (1200x900, ya recortada a 4:3) dentro de `.inst-media`, una clase que tenía el CSS escrito pero había quedado sin uso (antes llevaba `assets/instalacion.jpg`). **La foto es el render oficial de la tienda** (producto `essentia-simple-660`), recortado sobre el desagüe; el cliente pasó otra versión en despiece apilado que todavía no tenemos como archivo. El texto del panel lo redacté yo: conviene que lo valide el cliente.
