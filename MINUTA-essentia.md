...
6. **"Essentia desde adentro"** — *(ago 2026: se movió ACÁ, justo después de "Conocé cada
...
8. **"Dónde comprar"** — **OCULTO (ago 2026, pedido del cliente)**: la sección sigue en el
...
9. **CTA final** `#compra-segura` (enlazada desde el menú) "Compra segura" + bloque de **Garantía de 10 Años** (texto AISI 304-18/8 y 18/10) + botón **Dónde comprar** (al mapa) y la nota `.ml-nota` de los distribuidores.
...
11. **"El mismo acero, en el baño"** (`#otra-linea`, ago 2026) — cierre con botón outline
