...
4. **"Conocé cada detalle"** — barra de **3 opciones** (Modelos y colores · Modos de instalación · Desagüe), el panel se despliega debajo. El JS de los tabs es genérico (recorre todos los `.t3` y `.t3-panel`), así que sumar una opción es solo markup + pasar `.tabs3-bar` a 3 columnas:
