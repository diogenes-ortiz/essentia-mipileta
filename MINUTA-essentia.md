...
5. **"Essentia desde adentro"** — *(ago 2026: se movió ACÁ, justo después de "Conocé cada
   ...
   - **Desagüe** (ago 2026): foto `desague-essentia.jpg` (1200x900, ya recortada a 4:3) dentro de `.inst-media`, una clase que tenía el CSS escrito pero había quedado sin uso (antes llevaba `assets/instalacion.jpg`). La foto es el **despiece apilado** (tapa + filtro + cuerpo) que pasó el cliente, recortada 1:1 sobre la pieza. Va con `.inst-media--cuadrada` (marco 1:1, max-width 460px) porque la composición es vertical y en 4:3 quedaba chica y con mucho aire a los costados. Origen: `Downloads/ChatGPT Image Aug 24, 2026, 05_51_34 PM.png` (1254x1254). El texto del panel lo redacté yo: conviene que lo valide el cliente.
